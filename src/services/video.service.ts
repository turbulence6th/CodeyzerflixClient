...
import { Video, VideoFilter, VideoSaveRequest } from '../types/video.types';
...
export const adminVideoService = {
  ...
  uploadVideo: (formData: FormData) => axios.post<string>(`${ADMIN_API_BASE_URL}/videos/upload`, formData),
}; 